<?php 
/*
Template Name: Аренда конференц зала
*/
 ?>
<?php get_header(); ?>
...
<section id="choice">
    <div class="container">
        ...
        <h2><?php echo get_field('reasons_to_choose_a_rent_in_the_header'); ?></h2>
       




         <?php if (have_rows('reasons_to_choose_a_rent_tourists') ||  have_rows('reasons_to_choose_a_rent_travel') || have_rows('reasons_to_choose_a_rent_romantics_and_honeymooners') ): ?>


        <div class="tabs">
        <?php if (have_rows('reasons_to_choose_a_rent_tourists')): ?>
            <div class="tab">
                <div class="tab_text">
       ...
       <?php endif; ?>
         <?php if (have_rows('reasons_to_choose_a_rent_travel')): ?>
        ...
        <?php endif; ?>
                <?php if (have_rows('reasons_to_choose_a_rent_romantics_and_honeymooners')): ?>
            <div class="tab">
                <div class="tab_text">
       ...
       <?php endif; ?>
        ...
        <div class="tab_content">
            <div class="tab_panel">
                <?php if (have_rows('reasons_to_choose_a_rent_tourists')): ?>
                    <?php while (have_rows('reasons_to_choose_a_rent_tourists')): the_row(); ?>
            ...
            <div class="tab_panel">
                <?php if (have_rows('reasons_to_choose_a_rent_travel')): ?>
                    <?php while (have_rows('reasons_to_choose_a_rent_travel')): the_row(); ?>
            ...
            <div class="tab_panel">
                <?php if (have_rows('reasons_to_choose_a_hotel_romantics_and_honeymooners')): ?>
                    <?php while (have_rows('reasons_to_choose_a_rent_romantics_and_honeymooners')): the_row(); ?>
